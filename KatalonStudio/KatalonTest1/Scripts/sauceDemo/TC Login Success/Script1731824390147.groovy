...
WebUI.sendKeys(findTestObject('Page_Swag Labs/login_screen/saucedemo_username'), Login_Username)

WebUI.sendKeys(findTestObject('Page_Swag Labs/login_screen/saucedemo_password'), Login_Password)
